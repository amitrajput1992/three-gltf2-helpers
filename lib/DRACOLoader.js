...
var _draco_decoder = _interopRequireDefault(require("../src/draco/draco_decoder.js"));
...
DRACOLoader.prototype = {
  ...
  addAttributeToGeometry: function (dracoDecoder, decoder, dracoGeometry, attributeName, attributeType, attribute, geometry, geometryBuffer) {
    if (attribute.ptr === 0) {
  ...
  convertDracoGeometryTo3JS: function (dracoDecoder, decoder, geometryType, buffer, attributeUniqueIdMap, attributeTypeMap) {
    ...
    var geometry = new THREE.BufferGeometry(); // Add native Draco attribute type to geometry.
...
DRACOLoader.setDecoderConfig = function (config) {
  ...
  DRACOLoader.releaseDecoderModule(); // Reuse WASM binary.
...
DRACOLoader.getDecoderModule = function () {
  ...
  var promise = DRACOLoader.decoderModulePromise; // DracoDecoderModule: Using asm based script for backwards compatibility
  ...
  promise = Promise.resolve().then(function () {
    return new Promise(function (resolve) {
      ...
      (0, _draco_decoder.default)(config);
    });
  });
