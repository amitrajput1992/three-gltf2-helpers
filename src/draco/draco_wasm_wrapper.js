...
$jscomp.polyfill("Promise", function (d) {
  ...
  g.all = function (d) {
    var f = $jscomp.makeIterator(d), u = f.next();
    return u.done ? n([]) : new g(function (d, g) {
      ...
      var D = [], Q = 0;
      do D.push(void 0), Q++, n(u.value).callWhenSettled_(w(D.length - 1), g), u = f.next(); while (!u.done)
    })
  };
  return g
}, "es6", "es3");
var DracoDecoderModule = function (d) {
  ...
  function n(e, b) {
    ...
    l = "";
    if (128 > c) {
      for (; 0 < b;) c = String.fromCharCode.apply(String, T.subarray(e, e + Math.min(b, 1024))), l = l ? l + c : c, e += 1024, b -= 1024;
      return l
    }
  ...
  function Ma() {
    var e = a.usingWasm ? Aa : Sa, b = 2147483648 -
      e;
  ...
  function qa() {
    ...
    x[qa.buffer >> 2] = e;
    e = qa.buffer;
    for (var d = 0; d < l.length; d++) if (l[d] && a.___cxa_can_catch(l[d], c, e)) return e = x[e >>
    2], b.adjusted = e, (m.setTempRet0(l[d]), e) | 0;
    e = x[e >> 2];
  ...
  function Q(e, b) {
    ...
    try {
      ...
      return "undefined" !==
      typeof FS && Ca instanceof FS.ErrnoError || W(Ca), -Ca.errno
    }
  }
  ...
  (a.print = print), "undefined" != typeof printErr && (a.printErr = printErr), a.read = "undefined" != typeof read ? function (a) {
    return read(a)
  } : function () {
    ...
    "undefined" !== typeof console ? (a.print || (a.print = function (a) {
      console.log(a)
    }), a.printErr || (a.printErr = function (a) {
      console.warn(a)
    })) : a.print || (a.print = function (a) {
    }), "undefined" === typeof a.setWindowTitle && (a.setWindowTitle = function (a) {
    document.title = a
    ...
    setTempRet0: function (a) {
      ...
      switch (a) {
        ...
        case "double":
          return 8;
        default:
          return "*" === a[a.length - 1] ? m.QUANTUM_SIZE : "i" === a[0] ?
            (a = parseInt(a.substr(1)), f(0 === a % 8), a / 8) : 0
      }
    }, getNativeFieldSize: function (a) {
      return Math.max(m.getNativeTypeSize(a), m.QUANTUM_SIZE)
    }, STACK_ALIGN: 16, prepVararg: function (a, b) {
  ...
  var Aa = 65536, Sa = 16777216, ib = 16777216, fa, T, za,
    Oa, x, Pa, Qa, Ra, aa, Ga, U, xa, Ha, ba;
  ...
  if (a.buffer) var F = a.buffer; else "object" === typeof WebAssembly && "function" === typeof WebAssembly.Memory ? (a.wasmMemory = new WebAssembly.Memory({initial: y / Aa}), F = a.wasmMemory.buffer) : F = new ArrayBuffer(y);
  D();
  x[0] = 1668509029;
  za[1] = 25459;
  ...
  (function () {
    ...
    function b() {
      return a.wasmBinary || !oa && !ka || "function" !== typeof fetch ? new Promise(function (a, b) {
        a(e())
      }) : fetch(d, {credentials: "same-origin"}).then(function (a) {
    ...
    function c(c, e, l) {
      ...
      if (!(a.wasmMemory instanceof
        WebAssembly.Memory)) return a.printErr("no native wasm Memory in use"), !1;
      ...
      a.wasmBinary || "function" !== typeof WebAssembly.instantiateStreaming || 0 === d.indexOf("data:") || "function" !== typeof fetch ? k(E) : WebAssembly.instantiateStreaming(fetch(d, {credentials: "same-origin"}),
  ...
  a.asmLibraryArg = {
    abort: W, assert: f, enlargeMemory: Ma, getTotalMemory: function () {
      return y
    ...
    ___cxa_allocate_exception: function (a) {
      ...
      return a
    }, ___cxa_find_matching_catch: qa, ___cxa_pure_virtual: function () {
      ua = !0;
      throw"Pure virtual function called!";
    }, ___cxa_throw: function (a, b, c) {
      A.infos[a] = {ptr: a, adjusted: a, type: b, destructor: c, refcount: 0, caught: !1, rethrown: !1};
      A.last = a;
      "uncaught_exception" in na ? na.uncaught_exception++ : na.uncaught_exception =
        1;
    ...
    ___syscall140: function (a, b) {
    ...
    }, ___syscall146: Q, ___syscall54: function (a, b) {
      v.varargs = b;
      return 0
      ...
      try {
        ...
        return "undefined" !== typeof FS && l instanceof FS.ErrnoError ||
        W(l), -l.errno
      }
    }, _abort: function () {
      a.abort()
      ...
      La++;
      return 0
    }, _pthread_once: ra, _pthread_setspecific: function (a, b) {
      if (!(a in ya)) return 22;
      ya[a] = b;
      return 0
    }, DYNAMICTOP_PTR: ba, tempDoublePtr: Eb, ABORT: ua, STACKTOP: U, STACK_MAX: xa
  };
  var eb = a.asm(a.asmGlobalArg, a.asmLibraryArg, F);
  a.asm = eb;
  a.___cxa_can_catch = function () {
    return a.asm.___cxa_can_catch.apply(null,
      arguments)
  };
  ...
  var pb = a._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0 = function () {
    ...
    Gb = a._emscripten_bind_AttributeOctahedronTransform___destroy___0 = function () {
      ...
      return a.asm._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0.apply(null,
        arguments)
      ...
      return a.asm._emscripten_bind_AttributeQuantizationTransform_min_value_1.apply(null,
        arguments)
      ...
      return a.asm._emscripten_bind_AttributeTransformData_AttributeTransformData_0.apply(null,
        arguments)
      ...
      return a.asm._emscripten_bind_Decoder_DecodeBufferToPointCloud_2.apply(null,
        arguments)
      ...
      return a.asm._emscripten_bind_Decoder_GetAttributeId_2.apply(null,
        arguments)
    ...
    bc = a._emscripten_bind_Decoder_GetAttributeIntForAllPoints_3 = function () {
      ...
      return a.asm._emscripten_bind_Decoder_GetEncodedGeometryType_1.apply(null,
        arguments)
      ...
      return a.asm._emscripten_bind_Decoder_SkipAttributeTransform_1.apply(null,
        arguments)
      ...
      return a.asm._emscripten_bind_DracoInt16Array_GetValue_1.apply(null,
        arguments)
      ...
      return a.asm._emscripten_bind_DracoInt32Array_GetValue_1.apply(null,
        arguments)
      ...
      return a.asm._emscripten_bind_DracoInt8Array_GetValue_1.apply(null,
        arguments)
      ...
      return a.asm._emscripten_bind_DracoUInt16Array_GetValue_1.apply(null,
        arguments)
  ...
  a.dynCall_viiiii = function () {
    return a.asm.dynCall_viiiii.apply(null,
      arguments)
  };
  ...
  if (V) if ("function" === typeof a.locateFile ? V = a.locateFile(V) : a.memoryInitializerPrefixURL && (V = a.memoryInitializerPrefixURL + V), pa || wa) {
    ...
    if (a.memoryInitializerRequest) {
      var hb = function () {
        var d = a.memoryInitializerRequest, b = d.response;
        200 !== d.status && 0 !== d.status ? (console.warn("a problem seems to have happened with Module.memoryInitializerRequest, status: " + d.status + ", retrying " +
          V), gb()) : fb(b)
      };
  ...
  B.prototype.error_msg =
    B.prototype.error_msg = function () {
  ...
  C.__cache__ = {};
  a.Mesh = C;
  C.prototype.num_faces =
    C.prototype.num_faces = function () {
      return Lc(this.ptr)
    };
